...
from cartography.models.konnect.dp_client_certificate import (
...
def get(api_token: str, api_url: str, control_plane_id: str) -> List[Dict[str, Any]]:
    ...
    logger.info(
        f"Fetched {len(all_dp_client_certs)} DP client certificates for control plane {control_plane_id}"
    )
    return all_dp_client_certs


def transform(
    dp_client_certs: List[Dict[str, Any]], control_plane_id: str
) -> List[Dict[str, Any]]:
    """
