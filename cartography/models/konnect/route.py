...
@dataclass(frozen=True)
# (:KonnectControlPlane)-[:RESOURCE]->(:KonnectRoute)
class KonnectRouteToControlPlaneRel(CartographyRelSchema):
    ...
    properties: KonnectRouteToControlPlaneRelProperties = (
        KonnectRouteToControlPlaneRelProperties()
    )
...
class KonnectRouteToServiceRel(CartographyRelSchema):
    ...
    properties: KonnectRouteToServiceRelProperties = (
        KonnectRouteToServiceRelProperties()
    )
